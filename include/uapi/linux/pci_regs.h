...
#define  PCI_DVSEC_CXL_FLEXBUS_PORT_STATUS_OFFSET		0xE
#define   PCI_DVSEC_CXL_FLEXBUS_PORT_STATUS_CACHE_MASK		_BITUL(0)
#define   PCI_DVSEC_CXL_FLEXBUS_PORT_STATUS_MEM_MASK		_BITUL(2)
